...
if ( empty($portfolio_types) ) {
	...
	$wp_query = new WP_Query();
	$wp_query->query( array( 'post_type' => 'wpprojects_portfolio', 'portfoliotype' => $portfolio_types, 'posts_per_page' => $num_per_page, 'orderby' => 'meta_value' . $options['sort_numerically'], 'meta_key' => '_sortorder', 'order' => 'ASC', 'paged'=> $paged ) );
}
